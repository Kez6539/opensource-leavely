...
const pageUrl = `${SITE_URL}/employee-leave-tracker`

export const metadata: Metadata = {
  title: 'Employee Leave Tracker UK: Automatic Balance Tracking & Approvals',
  description:
    'Employee leave tracker that calculates balances automatically. Pro-rata, carry-over, accruals, and bank holidays handled for you. No more spreadsheets. £8/user/month. Free 14-day trial.',
  ...
  keywords: [
    ...
    'holiday leave tracker UK',
  ],
  openGraph: {
    title: 'Employee Leave Tracker — Leavely',
    description:
...
const faqs = [
  {
    q: 'How does automatic balance tracking work?',
    a: 'When an employee submits a leave request and it is approved, their balance updates immediately. You set the annual allowance and Leavely tracks everything from there: days used, days pending approval, and remaining balance. Pro-rata adjustments for part-timers and mid-year starters are calculated automatically.',
  },
  {
    q: 'Can Leavely handle carry-over rules?',
    a: 'Yes. You can configure how many days employees are allowed to carry over from one leave year to the next, and set an expiry date for carried-over days. Leavely enforces these rules automatically so you do not have to check them manually.',
  },
  {
    q: 'Does it replace our Excel holiday tracker?',
    a: 'Yes. Leavely replaces Excel spreadsheets entirely. Employees submit requests online, managers approve in one click, and balances update automatically. There is no formula to maintain, no shared file to break, and no risk of someone accidentally deleting a row.',
  },
  {
    q: 'How much does Leavely cost?',
    a: 'Leavely costs £8 per user per month with all features included. There are no setup fees, no tiers, and no annual contracts. Start with a free 14-day trial and no credit card.',
  },
]
  ...
  '@graph': [
    {
      ...
      operatingSystem: 'Web',
      description:
        'Employee leave tracker with automatic balance tracking, pro-rata calculations, carry-over rules, and one-click approvals.',
      offers: {
        '@type': 'Offer',
        price: '8.00',
        priceCurrency: 'GBP',
...
export default function EmployeeLeaveTrackerPage() {
  const registerUrl = '/register?utm_source=website&utm_campaign=employee_leave_tracker'
      ...
      <main>
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-12 md:pt-28 md:pb-16">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                Stop spending hours updating spreadsheets. Leavely automatically tracks every employee&apos;s leave balance, handles pro-rata calculations, and manages carry-over rules. You set it up once and it works on its own.
              </p>
        ...
        <section>
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                Leave tracking that runs itself
              </h2>
              <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
        ...
        <section className="bg-gray-50/50 border-y">
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
                No more &quot;how many days do I have left?&quot; questions. Employees check their own balance anytime.
              </p>
            </div>
