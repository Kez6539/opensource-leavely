...
const pageUrl = `${SITE_URL}/hr-software-uk`

export const metadata: Metadata = {
  title: 'HR Software UK: All in One for 5 to 100 Employees (2026)',
  description:
    'HR software built for UK businesses with 5 to 100 employees. Leave management, sickness tracking, Bradford Factor, TOIL, and absence reports. £8/user/month, all features included. Free 14-day trial.',
  ...
  keywords: [
    ...
    'HR software for SMEs UK',
    'people management software UK',
    'HR platform UK',
    'small business HR software',
  ],
  openGraph: {
    title: 'HR Software UK — Leavely',
    description:
      'All in one HR software for 5 to 100 employees. Leave management, sickness tracking, and absence reports. £8/user/month.',
    url: pageUrl,
    type: 'website',
  },
}
...
const faqs = [
  {
    q: 'Is Leavely a full HR software system?',
    a: 'Leavely covers the core HR functions that small and medium UK businesses need most: leave management, sickness absence tracking, Bradford Factor monitoring, return to work forms, TOIL tracking, employee records, and absence reporting. It is designed to replace spreadsheets and basic tools with a proper system, without the complexity of enterprise HR platforms.',
  },
  {
    q: 'How many employees can Leavely support?',
  ...
  },
  {
    ...
    a: 'Yes. Leavely includes UK bank holidays, statutory leave entitlements (5.6 weeks for full time employees), pro rata calculations for part time workers, Bradford Factor scoring for sickness management, and carry over rules. These are built in and calculated automatically.',
  },
  {
    q: 'Can Leavely replace our current HR spreadsheets?',
    a: 'Absolutely. Most of our customers switch from Excel, Google Sheets, or paper based tracking. Leavely automates everything that spreadsheets cannot: real time balance calculations, pro rata adjustments, Bradford Factor scoring, approval workflows, team calendars, and absence reporting. Setup takes 2 minutes.',
  },
  {
    q: 'Do I need an HR department to use Leavely?',
  ...
  '@graph': [
    {
      ...
      name: `${SITE_NAME} — HR Software UK`,
      url: pageUrl,
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web',
      description:
        'Leavely is HR software built for UK businesses with 5 to 100 employees. Leave management, sickness tracking, Bradford Factor, and absence reports all in one platform.',
...
export default function HRSoftwareUKPage() {
  const registerUrl = '/register?utm_source=website&utm_campaign=hr_software_uk'
      ...
      <main>
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-12 md:pt-28 md:pb-16">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                Your business has 5 to 100 employees. You do not need enterprise HR software with 200 features you will never use. You need something that handles leave, sickness, and absence management properly. That is Leavely.
              </p>
          ...
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
                Enterprise HR platforms try to do everything and end up being complex and expensive. Leavely focuses on the core HR functions that UK SMBs use every single day.
              </p>
            </div>
        ...
        <section className="bg-gradient-to-r from-emerald-600 to-teal-600">
          <div className="max-w-4xl mx-auto px-6 py-16 md:py-20 text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              Set up your HR software in 2 minutes
            </h2>
        ...
        <section>
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight text-center mb-4">
              HR software for every type of UK business
            </h2>
          ...
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
            ...
            <div className="space-y-6">
              {[
                ...
                { title: 'Affordable and transparent pricing', description: 'At £8 per user per month with every feature included, Leavely is priced for SMB budgets. A team of 20 costs £160 per month. A team of 50 costs £400 per month. No setup fees, no annual contract, cancel anytime.' },
                ...
                { title: 'Replaces spreadsheets and paper', description: 'If you are currently tracking leave with Excel, WhatsApp messages, or paper forms, Leavely replaces all of that with a proper system. Automatic calculations, approval workflows, and a team calendar that everyone can access.' },
              ].map((item) => (
        ...
        <section>
          <div className="max-w-4xl mx-auto px-6 py-16 md:py-20 text-center">
            ...
            <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
              No credit card. No sales calls. No annual contract. Just the HR software your UK business actually needs.
            </p>
            <div className="mt-8">
              <Link href={registerUrl}>
