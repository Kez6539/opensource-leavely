...
const pageUrl = `${SITE_URL}/staff-holiday-planners`

export const metadata: Metadata = {
  title: 'Staff Holiday Planners UK: Holiday Planning Tools for Teams (2026)',
  description:
    'Compare the best staff holiday planners for UK businesses. Visual team calendars, clash detection, blackout dates, and department views. Stop overlapping holidays causing coverage gaps. £8/user/month. Free 14-day trial.',
  ...
  keywords: [
    ...
    'team holiday planners',
    'staff leave planners',
    'employee holiday planners UK',
    'holiday planners for teams',
    'holiday rota planners',
    'staff holiday planning tools',
  ],
  openGraph: {
    title: 'Staff Holiday Planners for UK Businesses — Leavely',
    description:
      'Visual team calendars with clash detection and blackout dates. Plan holidays without the chaos. Free 14-day trial.',
    url: pageUrl,
    type: 'website',
  },
}
...
const faqs = [
  {
    q: 'What features should staff holiday planners include?',
    a: 'The best staff holiday planners offer a visual team calendar, clash detection when too many people request the same dates, blackout dates for busy periods, and role-based views so managers only see their team. Leavely includes all of these features at £8 per user per month.',
  },
  {
    q: 'Can holiday planners block certain dates from being booked?',
    a: 'Yes. Good holiday planning tools support blackout dates where no leave can be requested. This is useful for peak trading periods, month-end close, or any dates where you need full staffing. With Leavely, employees see blackout dates on their calendar and cannot submit requests for those dates.',
  },
  {
    q: 'Can different managers see different teams in holiday planners?',
  ...
  {
    q: 'How much do staff holiday planners cost?',
    a: 'Staff holiday planners range from free basic tools to enterprise platforms costing over £15 per user. Leavely costs £8 per user per month with all features included. There are no tiers, no setup fees, and no annual contracts. Every account starts with a free 14-day trial and no credit card is required.',
  },
]
  ...
  '@graph': [
    {
      ...
      operatingSystem: 'Web',
      description:
        'One of the best staff holiday planners for UK businesses with visual team calendars, clash detection, blackout dates, and department views.',
      offers: {
        '@type': 'Offer',
        price: '8.00',
        priceCurrency: 'GBP',
...
const features = [
  { icon: Eye, title: 'Visual team calendars', description: 'See every approved and pending holiday on a colour-coded calendar. Filter by team, department, or the whole company. Spot gaps and clashes at a glance.' },
...
export default function StaffHolidayPlannersPage() {
  const registerUrl = '/register?utm_source=website&utm_campaign=staff_holiday_planners'
      ...
      <main>
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-12 md:pt-28 md:pb-16">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
                Looking for the right holiday planning tool for your team? Leavely is one of the simplest staff holiday planners available. See who is off, spot clashes before they happen, and protect busy periods with blackout dates. Keep your team running smoothly all year.
              </p>
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                Holiday planning without the right tools is chaos
              </h2>
              <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
                These problems are completely avoidable with a proper holiday planner.
              </p>
            </div>
        ...
        <section>
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                What the best holiday planning tools offer
              </h2>
              <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
        ...
        <section>
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-28">
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight text-center mb-12">
              Why businesses choose Leavely over other holiday planners
            </h2>
