...
import { MapPin, Plus, QrCode, Printer, ToggleLeft, ToggleRight, Trash2, Copy, ExternalLink } from 'lucide-react'
import { createLocation, toggleLocationActive, deleteLocation } from '@/app/t/[tenantSlug]/settings/locations/actions'
...
export function LocationsTab({ tenantSlug, locations, isAdmin }: Props) {
  ...
  // (#151) Use the shared ConfirmDialog instead of native confirm().
  ...
  return (
    <div className="space-y-6">
      <CardSection
        ...
        description="Manage locations and QR codes for your team"
        action={
          isAdmin ? (
                  ...
                  <TableRow key={loc.id} className="hover:bg-accent/50 transition-colors">
                    ...
                    <TableCell>
                      <button
                        ...
                        className="inline-block rounded-md border p-1 hover:bg-accent/50 transition-colors"
                        title="View QR code"
                      >
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img
                          src={getQrCodeUrl(getClockInUrl(loc.qrToken), 48)}
                          alt={`QR for ${loc.name}`}
                          width={40}
                          height={40}
                          className="rounded"
